...
- `priority` — P0/P1/P2 per `05-execution\/PRIORITY_RUBRIC.md`;
...
**Schema**: `BR-ID | statement | source (file:line or doc) | module | criticality (P0/P1/P2) | confidence (CONFIRMED/INFERRED/ASSUMPTION/UNKNOWN — see 99-reference\/FAILURE_RULES.md §7) | owning_team_hint`
...
(`06-templates\/TEMPLATE_compliance_control.md`), so A16 derives E.3
...
`02-categories\/CAT_A_engineering.md`).
