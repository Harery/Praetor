...
marker (mid-chunk, per `references/protocols/CHUNKING_PROTOCOL.md`). The
...
```
=== PRAETOR RESUMABLE SNAPSHOT v2.8.4 ===
...
syntax (`references/execution/RUN_MODES.md`) — they are the same values, not a
