...
the Test-Type Ownership Map in `references/categories/CAT_A_engineering.md`.
...
`references/protocols/ARTIFACT_STATUS.md`; reference it rather than copying the set
