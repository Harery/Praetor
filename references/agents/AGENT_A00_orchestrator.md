...
counted separately (per `references/reference/BY_THE_NUMBERS.md`). You do not
...
authoritative tag set is `references/protocols/ARTIFACT_STATUS.md`.
...
1. Display the current Coverage Ledger state before any category section of
   ...
   canonical structure in `references/phases/PHASE_4_agent_swarm.md`) under
...
`references/protocols/RESUMABLE_STATE.md` before stopping.
