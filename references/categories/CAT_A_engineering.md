...
**Audience**: Engineering / QA. **Mandate**: `references/mandates/MANDATE_engineering.md`.
...
| A.14b | Secret Scan & Secret-Lint | Masked findings table + runnable CI stage (sub-type of A.14; see `references/mandates/SECRET_SCAN_MANDATE.md`) |
...
that expose bugs, per `references/protocols/ROOT_CAUSE_GROUPING.md`.)
